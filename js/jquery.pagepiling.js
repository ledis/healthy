    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function scrollPage(destination, animated) {
			if (destination.html() == undefined) return;
            var v ={
        ...
        */
        ...
        function activateNavDots(name, sectionIndex) {
            if(options.navigation){
                ...
                if (name)
                {
                    var $a = $('#pp-nav').find('a[href="#' + name + '"]');
                    $a.addClass('active');
                    var tooltip = $a.parent().data('tooltip');
                    $('<div class="pp-tooltip ' + options.navigation.position + '">' + tooltip + '</div>').hide().appendTo($a.parent()).fadeIn(200);
                } else
                {
                    var $a = $('#pp-nav').find('li').eq(sectionIndex).find('a');
                    $a.addClass('active');
                    var tooltip = $a.parent().data('tooltip');
                    $('<div class="pp-tooltip ' + options.navigation.position + '">' + tooltip + '</div>').hide().appendTo($a.parent()).fadeIn(200);
                }
